      ...
      <div class="addCategory" ref="addCategoryWindow">
          ...
          <form action="http://localhost:3000/category" method="POST">
              ...
              <div class="newCategoryTextInput">
                  <div class="codeInput">
                      <input type="text" name="code" ref="catCode" value="m" id="categoryCode" placeholder="code">
              ...
              <p class="codeInfo hidden" ref="formNote">don't forget to fill all form fields!</p>
